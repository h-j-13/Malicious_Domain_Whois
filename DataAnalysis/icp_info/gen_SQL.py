...
class SQL_generate(object):
    ...
    @staticmethod
    def SELECT_by_domain(domain, detail):
        """
        ...
        SQL = """SELECT {detail} FROM domain_whois.domain_whois_{num} WHERE domain_hash = {hash} """.format(
            detail=detail, num=table_num, hash=domain_hash,
        )
        # print SQL
        return SQL
...
if __name__ == '__main__':
    print 'test'
    print SQL_generate.SELECT_by_domain('agahii.ir')
